...
export default function GovHeader({ title, subtitle }) {
  ...
  return (
    <header className="relative bg-gradient-to-r from-blue-800 via-blue-900 to-blue-800 shadow-lg mb-6">
      ...
      <button
        ...
        className="absolute top-4 right-4 bg-red-600 text-white px-4 py-1.5 text-sm rounded hover:bg-red-700 transition"
      >
        Logout
      </button>
